$(function () {
  ...
  new ApexCharts(document.querySelector("#mood"), earning).render();
  ...
  const songs = [
    ...
    ["Poe","Amazed"],
    ["Four Tops","Reach Out_ I'll Be There"],
    ...
    ["John Parish / PJ Harvey","Urn With Dead Flowers In A Drained Pool"],
    ...
    ["Monica Zetterlund","The second time around"],
    ["She & Him","Sing"],
    ...
    ["The White Stripes","Prickly Thorn_ But Sweetly Worn"],
    ...
    ["Edie Brickell","More Than Friends"],
    ["T-Pain featuring Akon_ Diddy & Mary J. Blige","Change"],
    ...
    ["Morcheeba","Love Sweet Love (Featuring Mr Complex)"],
    ["Morcheeba","Shallow End"],
    ["Kathryn Williams","White_ Blue and Red"],
    ...
    ["Seeed","Walk Upright"],
    ["Era","Dark Voices"],
    ["CMW - Compton's Most Wanted","Hood Took Me Under"],
    ["Ashanti","In These Streets"],
    ["Fergie","Velvet"],
    ["Joni Mitchell","If"],
    ["Maxwell","Arroz Con Pollo"],
    ...
    ["Faithless","Miss U Less_ See U More"],
    ["Faithless","Angeline"],
    ...
    ["Clifford Brown / Max Roach","Blue Moon"],
    ["Hybrid","I Know"],
    ...
    ["Will Ackerman","Shella's Pictures"],
    ...
    ["Dwele","Truth"],
    ["Brad Mehldau","From This Moment On"],
    ...
    ["Brandy","Focus"],
    ["Keyshia Cole","Love_ I Thought You Had My Back"],
    ...
    ["Cartel","I Will Hide Myself Away/I Will Follow"],
    ["Monica","Getaway"],
    ...
    ["Tricky / The Mad Dog Reflex / Kioka Williams / DJ Muggs","Hot Like A Sauna"],
    ...
    ["Seal","Get It Together (Roy's Soldiers Of Universal Love Remix)"],
    ["Alison Moyet","That Ole Devil Called Love"],
    ["Teitur","Poetry and Aeroplanes"],
    ["John Martyn","May You Never"],
    ["Maxwell","The Suite Urban Theme (The Hush)"],
    ["The Verve","Rather Be"],
    ["KT Tunstall","Another Place To Fall"],
  ...
  // Select the first 10 items from the shuffled array using the slice method
  const randomItems = songs.slice(0, 10);
  var output = "<ol>";
  ...
  // TODO => Add randomizer for music content here
  music.innerHTML = output;

  var music_img = document.querySelector("#music-img");
  music_img.innerHTML="<img src=\"../assets/images/profile/"+ "music_listening.jpeg"+ "\" width=\"300\"/>"
})
